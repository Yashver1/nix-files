...
}:
{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      ...
      la = "lsd -la";
      ls = "lsd";
      gnb = "git -C /home/yash/.config/nix add . && git -C /home/yash/.config/nix commit -m 'flake update: nixos' && git -C /home/yash/.config/nix push  origin master && sudo nixos-rebuild switch --flake /home/yash/.config/nix/";
      ns = "nix-search-tv print | fzf --preview 'nix-search-tv preview {}' --scheme history";
      nb = "sudo nixos-rebuild switch --flake /home/yash/.config/nix/";
    };
